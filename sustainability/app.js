...
mongoose.connect("mongodb+srv://nandan:nandan@cluster0.bov9s.mongodb.net/test?retryWrites=true&w=majority",{useNewUrlParser:true, useUnifiedTopology:true},(err)=>{
				 if(err){
				 console.log("Something went wrong");
				 }
	             else{
				 console.log("Mongdb connection succeded");
				 }
				 });
...
cloudinary.config({ 
  cloud_name: 'dfv0lxwyn', 
  api_key: '345263114187962', 
  api_secret: 'vXh-EC_PMp4pTIaDrNEHxSXyYis'
});
